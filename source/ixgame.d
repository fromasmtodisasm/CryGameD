...
interface IXGame : IGame
{
	...
	*/
	...
	IXArea *CreateArea( const Vec3 *vPoints, const int count, const string[]	names, 
		const int type, const int groupId=-1, const float width=0.0f, const float height=0.0f);
	// box
	IXArea *CreateArea( const ref Vec3 min, const ref Vec3 max, const ref Matrix44 TM, const string[]	names, 

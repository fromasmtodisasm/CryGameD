...
*/
	...
	*/
		...
		ICVar * CreateVariable(const char * sName, int iValue,
				int nFlags, const char * help = "");
		ICVar * CreateVariable(const char * sName, float fValue, int nFlags,
				const char * help = "");
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		@see ICVar
	*/
		void UnregisterVariable(const char * sVarName, bool bDelete = false) = 0;
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
		char * GetVariable(const char * szVarName,
				const char * szFileName, const char * def_val);
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/*! Read a value from a configuration file (.ini) and return the value
		@param szVarName variable name
		@param szFileName source configuration file

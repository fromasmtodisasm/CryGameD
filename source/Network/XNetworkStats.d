...
public:
	...
	//!
	void Update( ref const CTimeValue inCurrentTime );
	...
	bool GetStats( const int iniN, ref DWORD outdwItem, ref DWORD outRelCount, ref DWORD outUnrelCount, ref size_t outSumBitSize );
...
private: 
	...
	vector!SCountSize				m_DrawStats;						//!< m_Stats[Item]=SCountSize
	vector!SCountSize				m_GatherStats;					//!< m_Stats[Item]=SCountSize
	CTimeValue										m_LastTimeReset;				//!< 

	vector!DWORD						m_SumGraphGather;				//!<
	vector!DWORD						m_SumGraphDraw;					//!<

...
*/
abstract class CGameObject : IEntityContainer
{
public:
	//! constructor
	//! destructor
	...
	override void SetEntity(IEntity* e)
	{
		m_pEntity = e;
	}
	...
	override bool QueryContainerInterface(ContainerInterfaceType desired_interface,
			void** ppInterface)
	{
		*ppInterface = null;
		return false;
	...
	override bool IsSaveable()
	{
		return (true);
	}

	override void OnEntityNetworkUpdate(ref const EntityId idViewerEntity,
			ref const Vec3d v3dViewer, ref uint32 inoutPriority,
